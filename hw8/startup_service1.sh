#!/bin/bash
# startup_service1.sh - Configures VM (web server) on first boot.
...
echo "[startup] Beginning setup for Service 1 (HW8) ..."
...
gcloud storage cp "gs://${SCRIPTS_BUCKET}/hw8-scripts/service1.py" /opt/service1/service1.py
...
[Unit]
Description=HW8 Service 1 - Python HTTP Web Server (Load Balanced)
